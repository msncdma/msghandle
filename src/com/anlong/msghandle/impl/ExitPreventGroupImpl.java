...
/**
 * @ClassName: ExitPreventGroupImpl 
 * @Package: com.anlong.imsghandle.impl
 * @company ShenZhen anlong Technology CO.,LTD.  
 * @Description: TODO 封装添加和删除群组成员请求数据流 
 * @author anlong 
 * @date 2013-4-28 下午3:16:29 
 * @version V1.0
 */
public class ExitPreventGroupImpl extends AbstractMsgHandle {
	
	/*@Override
	public void execute(Request113 request113) throws Exception {
		// 封装添加和删除群组成员请求数据流
		InitServerManager.startRequestMessageService(request113);
	}*/
}
